# Oh My Grok User Guide

Learn how to install, configure, and extend Oh My Grok, the terminal-based AI coding assistant from SpaceXAI.
...
Customize and extend Oh My Grok.
...
Automate, script, and integrate Oh My Grok with other systems.
